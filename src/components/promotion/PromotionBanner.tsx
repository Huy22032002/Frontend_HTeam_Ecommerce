...
const PromotionBanner = ({ backgroundColor = '#f5f5f5', variant = 'banner' }: PromotionBannerProps) => {
          ...
          <Box key={promo.id}>
            ...
            >
              ...
              <Typography
                ...
                mb={1}
              >
                {promo.type === 'PERCENTAGE' ? `Giảm ${promo.value}%` : `Giảm ${promo.value.toLocaleString()}₫`}
              </Typography>
